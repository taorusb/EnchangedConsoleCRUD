...
public class UpdateEndRequestReceiverController implements Handler {
    ...
    public void handle(String[] query) {
        ...
        switch (reqNumber) {
            case WRITERS:
                ...
                checkWriterField(query[3], query[4], query[5]);
                break;
            case POSTS:
                if (query.length > 5) {
                    System.out.println("Something is incorrect, please try again.");
    ...
    private void checkWriterField(String id, String firstName, String lastName) {
        ...
        showWriter.updateWriter(arg1, arg2, arg3);
    }
